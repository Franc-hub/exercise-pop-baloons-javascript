...
let ballonsMap = ['green', 'yellow', 'black', 'green', 'yellow', 'black', 'green', 'yellow', 'black','green', 'yellow', 'black','green', 'yellow', 'black','green', 'yellow', 'black','green', 'yellow'];
...
const render = () => {
    ...
    const ballons = ballonsMap.map((balloon) => {
        if(balloon === "yellow") {
              return `<div class="balloon active" style="background: yellow;"></div>`
        } 
        else if(balloon === "green") {
              return `<div class="balloon active" style="background: green;"></div>`
        } 
        else if(balloon === "black") {
              return `<div class="balloon active" style="background: black;"></div>`
        } 
